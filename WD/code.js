...
var count=1;
var mod=1;
var path=["songs\\Hrudaya Samudra.mp3"
,"songs\\Neecha Sullu Sutho.mp3"
,"songs\\Haavina Dwesha.mp3"
,"songs\\Santhoshakke.mp3"
,"songs\\Last Bench Party.mp3"
,"songs\\Saagarada.mp3"
,"songs\\O Sanjeya Hoove.mp3"
,"songs\\Kaarmoda Saridhu.mp3"
,"songs\\Yenaagali mundhe.mp3"
,"songs\\Raktha Sambandha.mp3"];

var sname=["Hrudaya Samudra",
"Neecha Sullu Sutho",
"Haavina Dwesha",
"Santhoshakke",
"Last Bench Party",
...
function moody(val){
	...
	//neutral
	index = Math.floor(Math.random()*(11-9)+9);
	index=parseInt(index);
	}
	//alert(index);
